# Move To Improve — Todo List

Use this list to track website changes over the coming weeks. Add a short description, target week, and any notes or links needed to complete each item.
...
- [ ] Create a new page explaining the logo design story and background.
- [ ] Add future idea here
